import { useCustomContext, InvItemContext, type EqItemType } from "./Context"
...
type Effect={
    ...
    effectOn: 'player' | 'enemy' | 'ally' | 'player & ally'
}
...
const itemSet : ItemType[] = [
    ...
    },
    {
        ...
        category: 'others', 
        effects: [
            {effectType: 'HP',effectQtty: +15, effectOn: 'player & ally'}
        ]
    },
    {
        name: 'disc', 
...
const takeEffect=(effect: Effect)=>{
    ...
    let entities=[]
        switch (effect.effectOn) {
            ...
            case 'player & ally': entities=[player, ally]; break;
        }
